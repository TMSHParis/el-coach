...
// Clerk en français, avec les libellés ECM de la page /signin.
const clerkLocalization = {
  ...frFR,
  formButtonPrimary: "Se connecter",
  signIn: {
    ...frFR.signIn,
    start: { ...frFR.signIn?.start, title: "", subtitle: "", actionText: "Pas encore inscrit ?", actionLink: "Je m'inscris" },
  },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return <ClerkProvider localization={clerkLocalization}>{shell}</ClerkProvider>;
}
